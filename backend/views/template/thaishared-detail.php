    ...
    <div class="widget-content ">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <b>วันที่ / เวลา ::</b> <?php echo date('d/m/Y H:i:s',strtotime($thaiSharedGameChit->thaiSharedGame->startDate)); ?> - <?php echo date('d/m/Y H:i:s',strtotime($thaiSharedGameChit->thaiSharedGame->endDate)); ?>
                <br><br>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            if(!empty($data)){
                                ...
                                foreach ($data['items'] as $val){
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo $val['discount']; ?></td>
                            ...
                            if(!empty($data)){
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><?php echo $data['discount_total'];; ?></td>
                                    <td></td>
