            ...
            <div class="row">
                    <div class="col-sm-6 col-sm-offset-6">
                        ...
                        <?php $form = ActiveForm::begin([
                            'id' => 'form-recommend',
                            'action' => Yii::$app->urlManager->createUrl(['recommend/index']),
		...
		echo GridView::widget ( [ 
                    ...
                    'columns' => [
                        ...
                        [ 
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                return number_format(YeekeeChitSearch::getAgentYeekeeChit($model['id']),3);
                            } 
                        ],
                        [ 
                            'label' => 'รายได้ทั้งหมด',
                            'contentOptions' => ['style' => 'text-align: right;'],
                            'value' => function ($model, $key, $index, $column) {
                                return number_format(YeekeeChitSearch::getAgentYeekeeChitAll($model['id']),3);
                            } 
                        ],
                        [ 
