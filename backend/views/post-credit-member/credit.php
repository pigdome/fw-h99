                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model, $key, $index, $column) {
                            if (in_array($model->action_id, [Constants::action_credit_top_up_admin, Constants::action_credit_withdraw_admin])) {
                                ...
                                $text = 'โปรโมชั่น';
                            } else if ($model->action_id == Constants::action_commission_withdraw_direct){
                                $color = 'red';
                    ...
                    [
                        ...
                        'value' => function ($model, $key, $index, $column) {
                            ...
                            } else if (in_array($model->action_id, [Constants::action_credit_top_up, Constants::action_credit_top_up_admin, Constants::action_commission_withdraw_direct])) {
