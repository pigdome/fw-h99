            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 text-right">
                        <strong>ส่วนลด :</strong> <strong class="discount_play_number"></strong>
                    </div>
                    <div class="col-xs-12 text-right">
                        <strong>จำนวนเงินทั้งหมด :</strong> <strong class="total_play_number"></strong>
                    </div>
                    <div class="col-xs-12 text-right">
                        <strong>คงเหลือ :</strong> <strong class="sum_play_number"></strong>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5">
