...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['auth_roles_id', 'safe'],
            ['recommend', 'string'],
            ['user_status', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_DELETED, self::STATUS_INACTIVE]],
        ];
    }
    ...
    {
        return $this->hasOne(UserHasBank::className(), ['user_id' => 'id']);
    }

    public function getCredit()
    {
        return $this->hasOne(Credit::className(), ['user_id' => 'id']);
    }
